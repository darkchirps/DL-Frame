/**
* author:Fany0219
* create:Fri Mar 06 2026 17:40:49 GMT+0800 (中国标准时间)
*/
...
import { UIClass, bundleType } from '../../../appDL/Manager/UIClass';

const { ccclass, property, menu } = _decorator;

@ccclass('mahLoading')
export class mahLoading extends UIScr {
...
UIMgr.register(new UIClass({
    ID: "mahLoading",
    parfabPath: "mahLoading",
    bundleName: bundleType.mahUi,
    group: "core"
}));