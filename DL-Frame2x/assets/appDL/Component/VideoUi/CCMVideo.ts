...
export default class CCMVideo extends cc.RenderComponent {
    ...
    @property(cc.Asset)
    protected source: cc.Asset | string = null;

    @property({ tooltip: "自动播放", visible(this: CCMVideo) { return this.source != null } })
    ...
    private initializeBrowser(): void {
        ...
        // @ts-ignore
        let gl = cc.renderer.device ? cc.renderer.device._gl : null;
        this.update = dt => {
            if (this.isInPlaybackState()) {
    ...
    private updateVideoSource(): void {
        ...
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.PREPARING);
    }
    ...
    private onReadyToPlay(): void {
        ...
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.READY);

        if (this.autoPlay || this.targetState == VideoState.PLAYING) {
            // this.play();
        }
    ...
    private onMetaLoaded(): void {
        ...
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.LOADED);
    }
    ...
    private onBufferStart(): void {
        ...
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.BUFFER_START);
    }

    private onBufferUpdate(): void {
        if (!cc.isValid(this.node)) return;
        this.node.emit('buffer_update', this);
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.BUFFER_UPDATE);
    }
    ...
    private onBufferEnd(): void {
        ...
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.BUFFER_END);
    }
    ...
    private onCompleted(): void {
        ...
        if (this.loop) {
            ...
            cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.COMPLETED);
        }
    }
    ...
    private onError() {
        ...
        cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.ERROR);
    }
    ...
    public play() {
        ...
        if (this.isInPlaybackState()) {
            ...
            if (this.currentState != VideoState.PLAYING) {
                ...
                cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.PLAYING);
            }
        } else {
            this.targetState = VideoState.PLAYING;
        }
    ...
    public pause() {
        ...
        if (this.isInPlaybackState() && this.currentState != VideoState.PAUSED) {
            ...
            cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.PAUSED);
        } else {
            this.targetState = VideoState.PAUSED;
        }
    }
    ...
    public stop() {
        ...
        if (this.isInPlaybackState() && this.currentState != VideoState.IDLE) {
            ...
            cc.Component.EventHandler.emitEvents(this.videoPlayerEvent, this, VideoEventType.STOPPED);
        } else {
            this.targetState = VideoState.IDLE;
        }
    }
